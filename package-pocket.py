...
RBF = os.path.join(ROOT, "projects", "output_files", "tp_pocket.rbf")
PKG = os.path.join(ROOT, "pkg", "pocket")
OUT = os.path.join(ROOT, "release", "pocket")
CORE_ID = "plasticbugs.timepilot"
...
# release contains everything needed to produce timeplt.rom.
for extra in ("timeplt.mra", "README.md", os.path.join("tools", "mra_build.py")):
...
print("build the ROM with:  python3 mra_build.py timeplt.mra timeplt.zip")
